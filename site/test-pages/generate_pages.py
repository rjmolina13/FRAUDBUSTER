...
def generate_job_card(job, is_fraud=False):
    """Generate HTML for a single job card with status indicator."""
    status_class = 'fraud' if is_fraud else 'legit'
    status_label = '🔴' if is_fraud else '🟢'
    ...
    <div class="job-card {status_class}">
        <div class="job-header">
            ...
            <div class="status-badge {status_class}" aria-label="{status_label}" title="{status_label}">{status_label}</div>
        </div>
